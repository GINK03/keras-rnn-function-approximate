...
#enc2 = Flatten()(enc2)
#enc2 = BN()(enc2)
#enc2 = Dense(1000, activation='relu')(enc2)
...
dec = Dense(500, activation='relu')(enc1)
dec = Dropout(0.3)(dec)
...
if '--train' in sys.argv:
  dataset = pickle.loads( open('カージオイド.pkl', 'rb').read() )
  ...
  model.fit( [X1, X2], y, shuffle=True, epochs=5, validation_data=([X1test, X2test], ytest) )
