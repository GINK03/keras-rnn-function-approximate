...
enc2 = Dense(100, activation='relu')(input2)
enc2 = Flatten()(enc2)
enc2 = BN()(enc2)
...
decode  = Dense(1, activation='linear')(dec)
...
if '--train' in sys.argv:
  ...
  model.fit( [X1, X2], y, shuffle=True, epochs=10, validation_data=([X1test, X2test], ytest) )
